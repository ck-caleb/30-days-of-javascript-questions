...
const slicingMiddleCompanies = itCompanies.splice(3, 1);
...
const removeMiddleCompanies = itCompanies.splice(3, 1);
...
// ?QUESTION 35.Compare the value of (min - average) and (max - average), use abs() method 1.Slice the first ten countries from the countries array
// ?QUESTION 36.Find the middle country(ies) in the countries array

// ?QUESTION 37.Divide the countries array into two equal arrays if it is even. If countries array is not even , one more country for the first half.
